...
insert into `integer`
value (127, 32767, 20000000, 90000000000);

select * from `integer`;

# Out of range 오류: 해당 데이터 타입의 범위를 벗어나는 경우 발생
# 0	62	15:23:38	insert into `integer`
...
/*
    ...
    한글: utf-8인코딩 기준 한 글자당 약 3바이트를 사용

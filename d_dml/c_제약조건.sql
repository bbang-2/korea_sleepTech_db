...
-- values
-- 	(1, '양현석', '1234'),
-- 	Error Code: 1048. Column 'phone' cannot be null	0.016 sec
-- 	(2, '양현석', null),
-- 	(3, '성재원', '1234');
...
values
	(1, '노트북', 3),
    (2, '스마트폰', null), # null 값 입력 시 null 값이 지정 (기본값 설정x)
    (3, '태블릿', 2);
...
# cf) 제약조건 사용 시 여러개 동시 지정 가능
# ex) not null + check
create table `multiple` (
	multiple_column int not null check(multiple_column >= 10)
);

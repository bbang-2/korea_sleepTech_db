...
/*
    ...
    begin
		SQL 프로그래밍 코딩
        : 각 문법의 구분 문자는 ; ($$가 나오기전까지는 스토어드 프로시저 종료가 아님)
...
# while 문 #
# : 조건이 참인 동안 SQL문장을 계속 번복
# cf) 스토어드 프로시저에서는 for문 지원x

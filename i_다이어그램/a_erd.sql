...
# 조건: 고유하게 식별가능해야 함(ex. 학번, 주민번호 등)
# : 사각형 형태, 엔티티명은 사각형 안에 명시
...
# 수강내역: 자식 테이블(수강ID PK, 학번 FK, 강의명 등)

# 관계 >> 1명의 학생은 여러개의 수강내역을 가질 수 있음(1:N 관계)

# ex) 주문과 주문상세내역 테이블
# 주문: 부모 테이블(주문ID PK, 주문 일시...등)
# 주문 상세 내역: 자식 테이블(주문ID PK, 주문상품...등)

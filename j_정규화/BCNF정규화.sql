...
# : 3.5 정규화
# : '모든 결정자'가 '후보키(유일성, 최소성)'가 되어야한다는 조건을 만족하는 정규형
...
/*
    ...
    2. 과목ID, 과목명
		>> 과목ID가 과목명을 결정한다면(함수 종속)일 경우 과목ID는 결정자이며 반드시 후보키여야만 함
*/
use `normalization`; 
